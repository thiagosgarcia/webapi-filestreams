...
namespace FileStreamPOC.Util
{
    public static class FileHelpers
    {
        ...
        public static async Task<byte[]> ProcessStreamedFile(
            MultipartSection section, Microsoft.Net.Http.Headers.ContentDispositionHeaderValue contentDisposition,
            ...
            try
            {
                ...
                else if (memoryStream.Length > sizeLimit)
                {
                    ...
                    modelState.AddModelError("File",
                        $"One or more part exceeds {megabyteSizeLimit:N1} MB.");
                }
